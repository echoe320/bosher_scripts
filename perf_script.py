...
'''
links = ["https://wayback.archive-it.org/org-1018/20170706202434/http://boshercollection.northwestern.edu/items/browse?type=18",
...
for link in links:
    ...
    content = BeautifulSoup(p_page.content, "html.parser")
    a_link = content.find_all('a', class_='permalink')
...
'''
links = []
main_link = "https://wayback.archive-it.org/org-1018/20170706204219/http://boshercollection.northwestern.edu/items/show/"

for i in range(459,462):
    link = "https://wayback.archive-it.org/org-1018/20170706204219/http://boshercollection.northwestern.edu/items/show/459"
    if i == 459:
        links.append(link)
    else:
        link1 = main_link + str(i)
        links.append(link)
...
for l in links:
    ...
    info(courtitles, "performance-item-type-metadata-course-title")
    info(courlocs, "performance-item-type-metadata-course-location")
    info(dots, "performance-item-type-metadata-date-of-translations")
    info(conofdatas, "performance-item-type-metadata-contributors-of-data")
    info(locarchs, "performance-item-type-metadata-local-archive-id")
    info(relimgs, "performance-item-type-metadata-related-images")
...
"Course title": courtitles,
"Course location": courlocs,
...
"Translator(s)": trans,
"Date of translation(s)": dots,
"Notes": notes,
"Source(s) of information": sois,
"Contributor(s) of data": conofdatas,
"Address": addrs,
"Street": streets,
"City": cities,
"Local archive ID": locarchs,
"Related images": relimgs,
"Tags": tags,
"Citation": cits
})
